...
const studyConfig = {
  topic: 'Book of Jonah',
  title: 'Jonah: God\'s Relentless Grace',
  days: 4,  // 4 chapters in Jonah - smaller test
  difficulty: 'intermediate',
  audience: 'group',
  style: 'book-study',
  requirements: 'Chapter-by-chapter exposition with historical context and verse-by-verse analysis'
};
// =====================================================
